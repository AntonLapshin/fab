document.getElementById(
  "code_snippet_0"
).innerText = `<script src="js/fab.min.js"></script>`;

document.getElementById("code_snippet_1").innerText = `const icon = \`
...
document.getElementById("code_snippet_2").innerText = `const icon1 = \`
